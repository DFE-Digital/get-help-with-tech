...
Rails.application.routes.draw do
  ...
  get '/devices/guide-to-resetting-windows-laptops-and-tablets/before_you_start', to: 'guide_to_resetting_windows_laptops_and_tablets#before_you_start'
  get '/devices/guide-to-resetting-windows-laptops-and-tablets/get_local_admin_and_bios_passwords', to: 'guide_to_resetting_windows_laptops_and_tablets#get_local_admin_and_bios_passwords'
  get '/devices/guide-to-resetting-windows-laptops-and-tablets/reset_the_bios_password', to: 'guide_to_resetting_windows_laptops_and_tablets#reset_the_bios_password'
  get '/devices/guide-to-resetting-windows-laptops-and-tablets/unlock_recovery_mode', to: 'guide_to_resetting_windows_laptops_and_tablets#unlock_recovery_mode'
  get '/devices/guide-to-resetting-windows-laptops-and-tablets/reset_the_device', to: 'guide_to_resetting_windows_laptops_and_tablets#reset_the_device'
  get '/devices/guide-to-resetting-windows-laptops-and-tablets/apply_your_own_settings', to: 'guide_to_resetting_windows_laptops_and_tablets#apply_your_own_settings'
  get '/devices/guide-to-resetting-windows-laptops-and-tablets/additional_support', to: 'guide_to_resetting_windows_laptops_and_tablets#additional_support'
