...
Rails.application.routes.draw do
  ...
  get '/guide-to-resetting-windows-laptops-and-tablets', to: 'guide_to_resetting_windows_laptops_and_tablets#index'
  get '/guide-to-resetting-windows-laptops-and-tablets/get-local-admin-and-bios-passwords', to: 'guide_to_resetting_windows_laptops_and_tablets#get_local_admin_and_bios_passwords'
  get '/guide-to-resetting-windows-laptops-and-tablets/before_you_start', to: 'guide_to_resetting_windows_laptops_and_tablets#before_you_start'
  get '/guide-to-resetting-windows-laptops-and-tablets/get_local_admin_and_bios_passwords', to: 'guide_to_resetting_windows_laptops_and_tablets#get_local_admin_and_bios_passwords'
  get '/guide-to-resetting-windows-laptops-and-tablets/reset_the_bios_password', to: 'guide_to_resetting_windows_laptops_and_tablets#reset_the_bios_password'
  get '/guide-to-resetting-windows-laptops-and-tablets/unlock_recovery_mode', to: 'guide_to_resetting_windows_laptops_and_tablets#unlock_recovery_mode'
  get '/guide-to-resetting-windows-laptops-and-tablets/reset_the_device', to: 'guide_to_resetting_windows_laptops_and_tablets#reset_the_device'
