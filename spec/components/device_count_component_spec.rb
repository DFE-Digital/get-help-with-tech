...
RSpec.describe DeviceCountComponent, type: :component do
  ...
  context 'when zero allocation present' do
    let(:school) { create(:school, :in_lockdown, laptops: [1, 1, 0]) }
  ...
  context 'when devices available' do
    let(:school) do
      create(:school, :in_lockdown, laptops: [10, 5, 1])
    end
  ...
  context 'with different allocations present' do
    let(:school) { create(:school, :in_lockdown, laptops: [10, 3, 1], routers: [10, 5, 2]) }
