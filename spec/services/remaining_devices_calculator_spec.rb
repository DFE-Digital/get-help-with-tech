...
RSpec.describe RemainingDevicesCalculator, type: :model do
  ...
  let(:devolved_schools) { create_list(:school, 3, :manages_orders, laptops: [1, 1, 0]) }
  let(:managed_schools) { create_list(:school, 3, :centrally_managed, laptops: [1, 1, 0]) }
