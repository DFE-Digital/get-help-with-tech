...
RSpec.describe 'Sign-in token behaviour', type: :feature do
  ...
  context 'with an invalid sign_in_token link' do
    ...
    it 'Visiting an invalid token link does not sign the user in' do
    ...
    it 'Visiting an invalid token link allows the user to request a new link' do
      visit broken_token_url
