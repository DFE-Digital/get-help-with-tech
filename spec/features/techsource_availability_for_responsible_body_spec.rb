...
RSpec.describe 'TechSource availability for responsible body' do
  ...
  it 'well before the techsource maintenance window' do
  ...
  it 'less than 2 days before the techsource maintenance window' do
  ...
  it 'during the techsource maintenance window' do
  ...
  it 'after the techsource maintenance window' do
