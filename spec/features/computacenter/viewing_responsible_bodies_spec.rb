...
RSpec.feature 'Viewing responsible bodies in the computacenter area', type: :feature do
  let(:responsible_bodies_page) { PageObjects::Computacenter::ResponsibleBodiesPage.new }
  ...
  scenario 'DfE users see the on-boarded responsible bodies and stats about them' do
    ...
    and_i_visit_the_computacenter_responsible_bodies_page
  ...
  def and_i_visit_the_computacenter_responsible_bodies_page
