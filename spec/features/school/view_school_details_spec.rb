...
RSpec.feature 'View school details' do
  ...
  before do
    create(:preorder_information, school: school_user.schools.first, who_will_order_devices: 'responsible_body', will_need_chromebooks: 'yes')
    create(:school_device_allocation, school: school_user.schools.first, device_type: 'std_device', allocation: 63)
  end
  ...
  context 'logged in as a school user' do
    ...
    context 'when I click on "Check your school details"' do
      ...
      it 'shows me my school details' do
        expect(page).to have_content(school_user.schools.first.name)
