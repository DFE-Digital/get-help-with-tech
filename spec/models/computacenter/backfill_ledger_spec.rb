  ...
  describe '#call when not initalized with given users' do
    context 'happy path' do
      ...
      it 'creates change record correctly' do
        ...
        expect(user_change.school).to eql(user.schools.first&.name)
        expect(user_change.school_urn).to eql(user.schools.first&.urn)
        expect(user_change.cc_ship_to_number).to eql(user.schools.first&.computacenter_reference)
