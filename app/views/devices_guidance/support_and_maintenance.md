...
For support with 4G wireless routers, key contacts (the person that completed your device forecast) and technical contacts can access the [Support Portal](https://computacenterprod.service-now.com/dfe). If you ordered after September 2020 then anyone with a TechSource account can request this support. They can also share access with colleagues.
...
If you receive a Microsoft Windows device that does not turn on, log in to the [Support Portal](https://computacenterprod.service-now.com/dfe) using the access details sent to the key contact(s) nominated when devices were ordered. Find out [how to return faulty devices](#replacing-a-faulty-device).

### If a Windows device develops a fault

If you received your device between May and August 2020 and a fault is discovered by you or someone you loan it to before 19 December 2020, we’ll arrange to fix or replace it. Find out [how to return faulty devices](#replacing-a-faulty-device) and the costs associated with doing so. 

If you received your device after September 2020 or discover a fault with the devices after 19 December 2020, it may still be covered by the manufacturer’s warranty. Please contact the manufacturer by following the returns information included with the device.

### Receiving a replacement device
...
If you receive a Google device that does not turn on, log in to the [Support Portal](https://computacenterprod.service-now.com/dfe) using the access details sent to the key contact(s) nominated when devices were ordered. Find out [how to return faulty devices](#replacing-a-faulty-device).

### If a Chromebook develops a fault

If you received your device between May and August 2020 and a fault is discovered by you or someone you loan it to before 19 December 2020, we’ll arrange to fix or replace it. Find out  [how to return faulty devices](#replacing-a-faulty-device) and the costs associated with doing so. 

If you received your device after September 2020 or discover a fault with the device after 19 December 2020, it may still be covered by the manufacturer’s warranty. Please contact the manufacturer by following the returns information included with the device.
...
The device will arrive without any settings installed. To ensure devices are appropriately protected to avoid the risk of young people accessing harmful content, please email [COVID.TECHNOLOGY@education.gov.uk](mailto:covid.technology@education.gov.uk) to get your device enrolled before distributing it.
...
If you work in social care or a school that does not own the device, please report faults to your local authority or academy trust so they can manage the process of requesting a replacement.

### If a device is not working within 3 days of receiving it

We’ll provide you with a replacement device within 2 working days of returning a device.
...
### For Windows and Chromebook devices issued between May and August 2020 and all 4G routers

If your device develops a fault after 3 working days of delivery, warranty support is available for faults reported before 19th December 2020.

Local authority and academy trust contacts can raise a support request on the [Support Portal](https://computacenterprod.service-now.com/dfe). Replacement devices will be provided within 2 working days of a ticket being logged.

Before placing a request for a warranty replacement we recommended you carry out an initial diagnosis to establish whether the fault is software or hardware related. Software problems and physically damaged devices are not covered by the warranty replacement service. Information on 'How to triage a hardware fault' is available on the [Support Portal](https://computacenterprod.service-now.com/dfe).
