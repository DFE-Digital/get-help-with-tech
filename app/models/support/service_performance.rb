class Support::ServicePerformance
  ...
  def total_devices_available
    sum_allocation("CASE order_state WHEN 'cannot_order' THEN raw_laptops_ordered ELSE raw_laptop_cap")
  end
  ...
  def total_devices_remaining
    sum_allocation("CASE order_state WHEN 'cannot_order' THEN 0 ELSE raw_laptop_cap - raw_laptops_ordered")
  end

  def total_routers_available
    sum_allocation("CASE order_state WHEN 'cannot_order' THEN raw_routers_ordered ELSE raw_router_cap")
  end
  ...
  def total_routers_remaining
    sum_allocation("CASE order_state WHEN 'cannot_order' THEN 0 ELSE raw_router_cap - raw_routers_ordered")
  end
  ...
  def number_of_devolved_schools_that_have_not_ordered_routers
    @number_of_devolved_schools_that_have_not_ordered_routers ||=
      number_of_devolved_schools_that_have(scope: School.where("raw_routers_ordered = 0 and CASE order_state WHEN 'cannot_order' THEN raw_routers_ordered > 0 ELSE raw_router_cap > 0"))
  end

  def number_of_devolved_schools_that_have_a_router_allocation
    @number_of_devolved_schools_that_have_a_router_allocation ||=
      number_of_devolved_schools_that_have(scope: School.where("CASE order_state WHEN 'cannot_order' THEN raw_routers_ordered > 0 ELSE raw_router_cap > 0"))
  end
  ...
  def number_of_responsible_bodies_managing_centrally_that_have_schools_with_a_router_allocation
    @number_of_responsible_bodies_managing_centrally_that_have_schools_with_a_router_allocation ||=
      ...
      .gias_status_open
      .responsible_body_will_order_devices
      .where("CASE order_state WHEN 'cannot_order' THEN raw_routers_ordered > 0 ELSE raw_router_cap > 0")
      .count('DISTINCT(responsible_body_id)')
  end
